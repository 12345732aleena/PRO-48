class Game{
    ...
    start(){
        ...
        noStroke();
        fill("yellow");
        text ("Jump And Run",width/2-200,height/2-200);
        player.sprite.visible = false;
        ground.visible = false;
        textSize(30);
    
        
        text ("You are a peasant who is going to the capital to get a a job in the palace,  you",width/2-700,height/2);
        text("are on your way there",width/2-200,height/2+50);
        text("you meet the demon wolf and his master who are coming in your way to", width/2-700,height/2+100);
        text("to save your life you have to reach the castel as soon as possible,press'space'to jump", width/2-300,height/2+150);
